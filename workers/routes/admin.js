// 2026-07-24 rev.4 — admin.js (AI 프로필 생성 프롬프트 재조정: 평가 톤을 평단/업계 공식평가 → 대중 이미지·별명·입소문 중심으로 전환, 마무리 문장 예시도 대중적 시선 위주로 교체)
/* ══════════════════════════════════════════════════════════════
   관리자 전용 API 라우트
   GET    /admin/title-map
   GET    /admin/rankings
  ...
  if (path === "/admin/persons/ai-draft" && request.method === "POST") {
    ...
    try {
      ...
      const systemPrompt =
        ...
        "자료가 많은 원로 배우면 1000자까지 늘어나도 된다. 단, 정보가 충분한 인물인데도 너무 " +
        ...
        "인물 이름으로 시작하는가, (2) 마지막 문장에 평가 또는 기대감이 담겨 있는가. 둘 중 " +
        "하나라도 아니면 그 부분을 고쳐서 다시 써라. " +
