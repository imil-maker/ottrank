/* ══════════════════════════════════════════════════════════════
   ...
   track.js     : /track/view  (작품/인물 페이지 실시간 조회 이벤트 기록, 2026-07-21 신설)
══════════════════════════════════════════════════════════════ */
...
export default {
  async fetch(request, env, ctx) {
    ...
    // 3-3. 실시간 조회 이벤트 기록 (작품/인물 페이지 조회 — 2026-07-21 신규)
    if (!res && path === "/track/view") {
      res = await handleTrack(path, request, env, headers);
    }
